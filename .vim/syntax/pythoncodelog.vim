" Vim syntax file
" Filetype:	Python Code Log
" Filenames:	*.pcl
" Maintainer:	Ljubomir Kurij <kurijlj@gmail.com>
" Last Change:	2011-08-06
"
"		This syntax file is based upon Python syntax file
"		for Vim maintained by Neil Schemenauer. Credits
"		are given bellow.
"
"
" Language:	Python
...
" Python Code Log Part
"
" Fields
syn match  pclTitle /^TITLE: /
syn match  pclDatetime /^DATETIME: /
syn match  pclTags /^TAGS: /
"syn match  pclComment /^COMMENT$/
"syn match  pclEndComment /^ENDCOMMENT$/
syn region pclComment  start="^COMMENT$" end="^ENDCOMMENT$" keepend
syn match  pclCode /^CODE$/
syn match  pclEndCode /^ENDCODE$/

hi def pclTitle  term=bold cterm=bold gui=bold guifg=indianred
hi def link pclDatetime  pclTitle
hi def link pclTags  pclTitle
"hi def link pclComment  pclTitle
"hi def link pclEndComment  pclTitle
hi def link pclComment  Comment
hi def link pclCode  pclTitle
hi def link pclEndCode  pclTitle
...
let b:current_syntax = "pythoncodelog"
